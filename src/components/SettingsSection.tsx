...
export default function SettingsSection() {
  return (
    <>
      ...
      <div className="flex items-center">
        <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
          <label htmlFor="login-password">
            ...
            <div className="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-[#b4a2c6]">
              <input
                type="password"
                id="login-password"
      ...
      <button className="mt-4 rounded-lg bg-[#b4a2c6] hover:bg-[#7431b6] px-4 py-2 text-white">
        Save Password
      </button>
      <hr className="mt-4 mb-8" />
